export const SETTINGS = "/admin/createrestaurant/:objid/settings";
export const RESLIST = "/admin/createrestaurant";

export const VOIDORDER = "/admin/:objID/void/:ordervisit";
export const VOID = "/admin/:objID/void";
export const ADMINPAGE = "/admin/:objID";
